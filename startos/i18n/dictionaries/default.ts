...
const dict = {
  ...
  'Watch-only wallet scanner returned an invalid response': 70,
  'Still scanning watch-only wallet — waiting for balance data...': 71,
  'Still scanning watch-only wallet for ': 72,
  'Watch-only wallet scan idle': 73,
  'Balance Source': 64,
